 ...
 * @author danie
 */
public class ConsultaPessoaFisica extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaPessoaFisica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
